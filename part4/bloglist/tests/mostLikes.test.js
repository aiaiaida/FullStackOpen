...
describe('return author with most likes', () => {
  ...
  test('multiple blogs in the list, return the author with most likes', () => {
    ...
    assert.deepStrictEqual(res, mostLikesAuthor)
  })
  ...
  test('one blog, return it', () => {
    ...
    assert.deepStrictEqual(res, most)
  })

  // test with empty list
  test('empty, return null', () => {
    res = listHelper.mostLikes(emptyBlog)
